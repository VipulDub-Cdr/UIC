...
export default function Footer(){
    ...
    return (
        <div className="relative w-full h-60 border-0 border-red-500 flex justify-center items-center overflow-hidden bg-black dark:bg-white">
            <div className="w-full flex justify-end h-full border-0 border-white">
                <div className="w-[20%] border-0 border-white flex flex-col justify-center items-start gap-[2px]">
                    ...
                    <div onClick={()=>router.push("/#comps")} className="text-white dark:text-black text-2xl font-semibold cursor-pointer hover:underline hover:underline-offset-2">Components</div>
                    ...
                    <div onClick={()=>router.push("/#faqs")} className="text-white dark:text-black text-2xl font-semibold cursor-pointer hover:underline hover:underline-offset-2">FAQs</div>
                </div>
            </div>
