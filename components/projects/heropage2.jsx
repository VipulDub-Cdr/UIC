...
export default function Project2() {
    ...
    const [card2Expand, setcard2Expand] = useState(false);
    ...
    return (
        ...
        <div onClick={() => setcard2Expand(!card2Expand)} id="card2" className="relative ring-2 ring-neutral-400 inset-shadow-sm inset-shadow-neutral-500 cursor-pointer hover:bg-neutral-950 w-full h-20 rounded-3xl border-2 border-neutral-700 p-2 flex flex-row justify-center items-start gap-2 bg-black shadow-lg shadow-neutral-400 dark:shadow-neutral-900  dark:inset-shadow-neutral-700">
            ...
            <div className="w-[75%] h-full border-0 border-white flex flex-col justify-start overflow-hidden">
                <div className="font-semibold w-full border-0 border-white text-white">Centered Hero Layout 2</div>
                ...
                <div id="insidecard2" className={`w-full border-0 border-yellow-400 pt-4 h-0 overflow-hidden text-white flex flex-col justify-center items-start`}>
                    ...
                    <div className="w-full h-full overflow-hidden border-0 border-red-500 mt-2 bg-black mb-[3px] rounded-2xl">
                        ...
                        <LensDemoThird urlImage="/heropage2.png" />
