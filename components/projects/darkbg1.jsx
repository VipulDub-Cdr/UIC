...
export default function Darkbg1() {

    const [card8Expand, setcard8Expand] = useState(false);
    ...
    return (
        ...
        <div onClick={() => setcard8Expand(!card8Expand)} id="card8" className="relative ring-2 ring-neutral-400 inset-shadow-sm inset-shadow-neutral-500 cursor-pointer hover:bg-neutral-950 w-full h-20 rounded-3xl border-2 border-neutral-700 p-2 flex flex-row justify-center items-start gap-2 bg-black shadow-lg shadow-neutral-400 dark:shadow-neutral-900  dark:inset-shadow-neutral-700">
            {/* flex justify-center items-center */}
            <div className="relative w-[25%] md:w-[10%] h-15 bg-neutral-950 text-white rounded-2xl inset-shadow-sm inset-shadow-black/70 overflow-hidden flex justify-around items-center">

                <div className="w-[2px] h-full bg-neutral-800"></div>
                <div className="w-[2px] h-full bg-neutral-800"></div>
                <div className="w-[2px] h-full bg-neutral-800"></div>
            ...
            <div className="w-[75%] h-full border-0 border-white flex flex-col justify-start overflow-hidden">
                <div className="font-semibold w-full border-0 border-white text-white">Neutral-500 Vertical Lines</div>
