...
export function LensDemoThird({urlImage}) {
  const [hovering, setHovering] = useState(false);

  return (
    <div className="w-full h-full border-0 border-blue-400">
      <Lens>
        <div
          className="w-full h-full relative overflow-hidden bg-black p-0 border-0 border-yellow-900">
          {/* <Rays />   */}
          {/* <Beams /> */}
          <div className="h-full w-full ring-0 ring-amber-500 relative">
            <img
              src={`${urlImage}`}
              alt="image"
